            ...
            <div className="mentor">
                ...
                <ol className="NameMentor">
                    <li className="mentors">
                        ...
                        {
                            rolan.map(el => (
                                <Link className="link  " to="/rolan" key={el.id}>
                                    {el.name}
                                </Link>
                    ...
                    <li className="mentors">
                        {
                            bekbol.map(el => (
                                <Link className="link  " to="/bekbol" key={el.id}>
                                    {el.name}
                                </Link>
                    ...
                    <li className="mentors">
                        {
                            taalai.map(el => (
                                <Link className="link  " to="/taalai" key={el.id}>
                                    {el.name}
                                </Link>
                    ...
                    <li className="mentors">
                        {
                            baktiyar.map(el => (
                                <Link className="link  " to="/baktier" key={el.id}>
                                    {el.name}
                                </Link>
                    ...
                    <li className="mentors">
                        {
                            medil.map(el => (
                                <Link className="link  " to="/medil" key={el.id}>
                                    {el.name}
                                </Link>
                    ...
                    <li className="mentors">
                        {
                            dastan.map(el => (
                                <Link className="link  " to="/dastan" key={el.id}>
                                    {el.name}
                                </Link>
